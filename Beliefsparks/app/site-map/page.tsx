  ...
  const sections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "— Vatican II Series —", href: "", isHeader: true },
        { name: "Vatican II Overview", href: "/catholicism/vatican-ii" },
        { name: "The World Before the Council", href: "/catholicism/vatican-ii/context" },
        { name: "The Four Constitutions", href: "/catholicism/vatican-ii/constitutions" },
        { name: "Liturgical Revolution", href: "/catholicism/vatican-ii/liturgy" },
        { name: "Ecumenism & Interfaith", href: "/catholicism/vatican-ii/ecumenism" },
        { name: "Legacy Today", href: "/catholicism/vatican-ii/legacy" },

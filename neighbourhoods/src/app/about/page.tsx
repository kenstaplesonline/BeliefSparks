...
import { MapPin, Heart, Users, Mail, Phone, Building2, Shield, AlertCircle, CheckCircle, Info, X } from "lucide-react";
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            ...
            <div className="bg-accent/10 p-6 rounded-lg text-white text-center">
              <div className="text-4xl font-bold mb-2">3</div>
              <div className="text-xl font-semibold">Northwest Calgary</div>
              <div className="text-sm">Coming Soon</div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-8 text-center">
            To showcase positive aspects of every single Calgary neighborhood, creating connection, pride, and appreciation for our communities.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">We use real data and verified statistics to tell authentic stories about each neighborhood.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <Users className="w-12 h-12 text-secondary mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Community-First</h3>
              <p className="text-gray-600">Every community has its own personality. We focus on what makes each area special, not generic praise.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <Heart className="w-12 h-12 text-accent mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Authentic Stories</h3>
              <p className="text-gray-600">No promotional fluff. Just genuine insights from people who actually live there.</p>
            </div>
          </div>
        </div>
      </section>

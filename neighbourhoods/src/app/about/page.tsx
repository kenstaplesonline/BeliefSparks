import { MapPin, Heart, Users, Mail, Phone } from "lucide-react";
      ...
      <section className="bg-gradient-to-br from-primary-dark via-primary to-primary-light text-white py-16 md:py-20 px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-red-100 mb-8">
            Calgary is more than just a city — it's a collection of unique, vibrant communities, each with its own personality, stories, and reasons to love it. We're here to celebrate every single one of them.
          </p>
        </div>
      </section>

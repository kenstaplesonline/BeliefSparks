...
export default function Home() {
  const mapLocations = [
    { name: "Kensington", lat: 51.052548, lng: -114.085904, url: "/neighborhoods/kensington" },
    { name: "Mission Cliff Bungalow", lat: 51.030604, lng: -114.071485, url: "/neighborhoods/mission-cliff-bungalow" },
    { name: "Sunnyside", lat: 51.056084, lng: -114.081477, url: "/neighborhoods/sunnyside" },
    { name: "Deer Run", lat: 50.918058, lng: -114.008305, url: "/neighborhoods/deer-run" },
    { name: "Altadore", lat: 51.016000, lng: -114.100473, url: "/neighborhoods/altadore" },
    { name: "Southwood", lat: 50.956900, lng: -114.084361, url: "/neighborhoods/southwood" },
    { name: "Bowness", lat: 51.096732, lng: -114.195610, url: "/neighborhoods/bowness" },
    { name: "Panorama Hills", lat: 51.156557, lng: -114.066497, url: "/neighborhoods/panorama-hills" },
    { name: "Forest Lawn", lat: 51.037823, lng: -113.981773, url: "/neighborhoods/forest-lawn" },
    { name: "Saddleridge", lat: 51.132449, lng: -113.946684, url: "/neighborhoods/saddleridge" },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Click on a marker to discover our featured neighborhoods and start exploring.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Small town feel on the river with famous park",
                quadrant: "NW"
              },
              {
                name: "Panorama Hills",
                tagline: "Elevated Living with Sweeping Views",
                description: "Sweeping views and modern family living",
                quadrant: "NW"
              },
              {
                name: "Forest Lawn",
                tagline: "Culinary Capital & Cultural Heart",
                description: "Global cuisines, vibrant murals, and resilient community spirit",
                quadrant: "SE"
              },
              {
                name: "Saddleridge",
                tagline: "Young Energy & Modern Convenience",
                description: "Youthful community with great amenities and direct LRT access",
                quadrant: "NE"
              }
            ].map((hood) => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            <div className="bg-primary/10 p-6 rounded-lg text-white text-center">
              ...
              <div className="text-sm">Across All Calgary Quadrants</div>
            </div>
            <div className="bg-secondary/10 p-6 rounded-lg text-white text-center">
              ...
              <div className="text-sm">More neighborhoods added weekly</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm text-red-200 mb-8">
            <strong>Our Communities:</strong> We currently have 10 detailed neighborhood profiles across Calgary's diverse quadrants, with more coming soon.
          </p>
          <div className="mt-8 flex flex-wrap gap-3 justify-center">
            ...
            {" "}
            <a href="/neighborhoods/deer-run" className="text-primary hover:underline">Deer Run</a>
            {" "}
            ...
            {" "}
            <a href="/neighborhoods/bowness" className="text-primary hover:underline">Bowness</a>
            {" "}
            <a href="/neighborhoods/panorama-hills" className="text-primary hover:underline">Panorama Hills</a>
            {" "}
            <a href="/neighborhoods/forest-lawn" className="text-primary hover:underline">Forest Lawn</a>
            {" "}
            <a href="/neighborhoods/saddleridge" className="text-primary hover:underline">Saddleridge</a>
          </div>
        </div>
      </section>

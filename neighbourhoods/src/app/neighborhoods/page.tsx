...
const neighborhoods = [
  { name: "Kensington", slug: "kensington", quadrant: "NW", tagline: "Vibrant & Walkable Urban Village" },
  { name: "Mission Cliff Bungalow", slug: "mission-cliff-bungalow", quadrant: "SW", tagline: "Historic Charm Meets River Living" },
  { name: "Sunnyside", slug: "sunnyside", quadrant: "NW", tagline: "Community Spirit & Stunning Views" },
  { name: "Deer Run", slug: "deer-run", quadrant: "SE", tagline: "Family Paradise with Endless Amenities" },
  { name: "Altadore", slug: "altadore", quadrant: "SW", tagline: "Urban Oasis Steps from the River" },
  { name: "Southwood", slug: "southwood", quadrant: "SW", tagline: "Established Comfort with Modern Appeal" },
  { name: "Bowness", slug: "bowness", quadrant: "NW", tagline: "Historic Village on the Bow" },
  { name: "Panorama Hills", slug: "panorama-hills", quadrant: "NW", tagline: "Elevated Living with Sweeping Views" },
  { name: "Forest Lawn", slug: "forest-lawn", quadrant: "SE", tagline: "Culinary Capital & Cultural Heart" },
  { name: "Saddleridge", slug: "saddleridge", quadrant: "NE", tagline: "Young Energy & Modern Convenience" },
];
